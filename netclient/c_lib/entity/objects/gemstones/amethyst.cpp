...
// private
static void set_amethyst_gemstone_properties(Object* obj)
{   // attach components
    ...
    obj->tick = &tick_amethyst_gemstone;
    //obj->update = NULL;
}
...
{
    // initialize object
    ObjectType type = OBJECT_GEMSTONE_AMETHYST;
    Object* obj = object_list->create(type);
    if (obj == NULL) return NULL;
    set_amethyst_gemstone_properties(obj);
    return obj;
}
