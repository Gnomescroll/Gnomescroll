...
static void set_soft_rock_block_drop_properties(Object* object)
{
    ...
    voxel->texture_index = t_map::get_cube_primary_texture_index((char*)"soft_rock");   // TODO -- use cached values
    ...
    object->tick = &tick_soft_rock_block_drop;
...
{
    ObjectType type = OBJECT_SOFT_ROCK_BLOCK_DROP;
    Object* obj = object_list->create(type);
    if (obj == NULL) return NULL;
    set_soft_rock_block_drop_properties(obj);
    return obj;
}
