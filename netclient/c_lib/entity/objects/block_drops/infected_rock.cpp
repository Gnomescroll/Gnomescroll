...
static void set_infected_rock_block_drop_properties(Object* object)
{
    #if DC_CLIENT
    ...
    voxel->texture_index = t_map::get_cube_primary_texture_index((char*)"infested_rock");   // TODO -- use cached values
    ...
    object->tick = &tick_infected_rock_block_drop;
...
{
    ObjectType type = OBJECT_INFECTED_ROCK_BLOCK_DROP;
    Object* obj = object_list->create(type);
    if (obj == NULL) return NULL;
    set_infected_rock_block_drop_properties(obj);
    return obj;
}
