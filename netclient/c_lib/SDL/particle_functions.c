...
//struct Camera* particle_cam=NULL;
...
////particle_cam = _get_camera();
///*
    //if(particle_cam != NULL) {
...
///* Vector shit that shouldnt be here */
...
//int _planar_laser(float x0, float y0, float z0, float x1, float y1, float z1) {
    ...
    //if(particle_cam == NULL) {
        ...
        //return 0;
    //}
    //struct Vec pos = init_Vec(particle_cam->x, particle_cam->y, particle_cam->z);

    ////printf("pos= %f, %f, %f \n", particle_cam->x, particle_cam->y, particle_cam->z);
...
//int _planar_laser2(int density, float width, float x0, float y0, float z0, float x1, float y1, float z1) {
    ...
    //float bx,by,bz;
    ////struct Vec* vl, vr;
    //struct Vec pos = init_Vec(particle_cam->x, particle_cam->y, particle_cam->z); //camera position
...
int _planar_laser(float x0, float y0, float z0, float x1, float y1, float z1) {
    ...
    //printf("pos= %f, %f, %f \n", particle_c->x, particle_c->y, particle_c->z);
