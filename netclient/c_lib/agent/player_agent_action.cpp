...
void PlayerAgent_action::fire() {
    ...
    //msg.id = p->agent_id;
    //msg.type = p->you->weapons.active_type();   // just send type for now. weapons arent in a list
    //msg.send();
}
...
int PlayerAgent_action::set_block() {
    ...
    //if (cube_intersects(
        //p->you->s.x, p->you->s.y, p->you->s.z,
        //0.3, 0.3, p->you->box.b_height,
        //b[0], b[1], b[2],
        //1, 1, 1))
    //{
        //return 1;
