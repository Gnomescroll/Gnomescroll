...
enum MONSTER_SPAWNER_BODY_PARTS {
    MONSTER_SPAWNER_PART_BODY
};
const float MONSTER_SPAWNER_ANIMATION_PARTICLE_SIZE = 0.2f;
const int MONSTER_SPAWNER_ANIMATION_PARTICLE_COUNT = 5*5*5;
const struct Color MONSTER_SPAWNER_ANIMATION_COLOR = { 50,1,1 };
