...
SOUND_TRIGGER_HEADER(walking)
SOUND_TRIGGER_HEADER(running)
SOUND_TRIGGER_HEADER(jetpack_on)
SOUND_TRIGGER_HEADER(soft_landing)
SOUND_TRIGGER_HEADER(medium_landing)
SOUND_TRIGGER_HEADER(hard_landing)
