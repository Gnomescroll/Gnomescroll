...
#define CONTAINER_ENTRY_DELIMITER          "-"
...
const size_t CONTAINER_ENTRY_DELIMITER_LENGTH          = sizeof(CONTAINER_ENTRY_DELIMITER) - 1;
...
void verify_config()
{
    ...
    GS_ASSERT_ABORT(strcmp(CONTAINER_ENTRY_DELIMITER, "-") == 0);
    GS_ASSERT_ABORT(strstr(CONTAINER_ENTRY_DELIMITER, ":") == NULL);
    GS_ASSERT_ABORT(strstr(CONTAINER_ENTRY_DELIMITER, " ") == NULL);
    GS_ASSERT_ABORT(strlen(CONTAINER_ENTRY_DELIMITER) == PROPERTY_DELIMITER_LENGTH);
    GS_ASSERT_ABORT(strstr(CONTAINER_ENTRY_DELIMITER, TAG_DELIMITER)             == NULL);
    GS_ASSERT_ABORT(strstr(CONTAINER_ENTRY_DELIMITER, COLOR_COMPONENT_DELIMITER) == NULL);
    GS_ASSERT_ABORT(CONTAINER_ENTRY_DELIMITER_LENGTH == 1);
