...
#define PLAYER_EQUIPMENT_LOCATION_SUBNAME     "equipment"
...
#define PLAYER_EQUIPMENT_LOCATION_NAME     PLAYER_CONTAINER_LOCATION_PREFIX PLAYER_EQUIPMENT_LOCATION_SUBNAME
