...
#define CONTAINER_SEPARATOR_PREFIX         "+"
...
const size_t CONTAINER_SEPARATOR_PREFIX_LENGTH         = sizeof(CONTAINER_SEPARATOR_PREFIX)       - 1;
...
const size_t CONTAINER_SEPARATOR_LINE_LENGTH = CONTAINER_SEPARATOR_PREFIX_LENGTH + CONTAINER_ID_LENGTH;
...
const char CONTAINER_SEPARATOR_FMT[] =
    CONTAINER_SEPARATOR_PREFIX
...
void verify_config()
{
    ...
    GS_ASSERT_ABORT(strcmp(CONTAINER_SEPARATOR_PREFIX, "+") == 0);
    GS_ASSERT_ABORT(CONTAINER_SEPARATOR_PREFIX_LENGTH == 1);
    ...
    GS_ASSERT_ABORT(strstr(CONTAINER_SEPARATOR_FMT, CONTAINER_SEPARATOR_PREFIX) == CONTAINER_SEPARATOR_FMT);
