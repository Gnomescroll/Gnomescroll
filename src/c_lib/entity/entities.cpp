...
void stress_test()
{
    ...
    printf("Begin entity stress test, maxing out %d %d times\n", type, iters);
    int ttl = 0;
...
static Vec3 get_default_spawn_position(Entity* entity)
{
    int h = 1;
...
static void spawn_monsters(EntityType type, int n, Vec3 (*get_spawn_position)(Entity* entity))
{
