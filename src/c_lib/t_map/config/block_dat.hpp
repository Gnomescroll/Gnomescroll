...
void load_block_dat()
{
    ...
    cube_def(ERROR_CUBE, ErrorBlock, "error_block");
...
*/
    ...
    cube_def(ERROR_CUBE-1, SolidBlock, "cell1", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 1,1);
    push_texture();
    hud_def(1,5, t3,1,1);

    cube_def(ERROR_CUBE-2, SolidBlock, "cell2", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 2,1);
    push_texture();
    hud_def(1,6, t3,2,1);

    cube_def(ERROR_CUBE-3, SolidBlock, "cell3", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 3,1);
    push_texture();
    hud_def(1,7, t3,3,1);

    cube_def(ERROR_CUBE-4, SolidBlock, "cell4", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 4,1);
    push_texture();
    hud_def(1,8, t3,4,1);

    cube_def(ERROR_CUBE-5, SolidBlock, "cell5", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 5,1);
    push_texture();
    hud_def(2,4, t3,5,1);

    cube_def(ERROR_CUBE-6, SolidBlock, "cell6", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 6,1);
    push_texture();
    hud_def(2,5, t3,6,1);

    // dupe
    //cube_def(ERROR_CUBE-7, SolidBlock, "cell7", CUBE_MATERIAL_DECORATION);
    //iso_texture(t3, 7,1);
    //push_texture();
    //hud_def(2,6, t3,7,1);

    cube_def(ERROR_CUBE-8, SolidBlock, "cell8", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 8,1);
    push_texture();
    hud_def(2,7, t3,8,1);

    cube_def(ERROR_CUBE-9, SolidBlock, "cell9", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 1,2);
    push_texture();
    hud_def(2,8, t3,1,2);
    
    cube_def(ERROR_CUBE-10, SolidBlock, "cell10", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 2,2);
    push_texture();
    hud_def(3,1, t3,2,2);

    cube_def(ERROR_CUBE-11, SolidBlock, "cell11", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 3,2);
    push_texture();
    hud_def(3,2, t3,3,2);

    cube_def(ERROR_CUBE-12, SolidBlock, "cell12", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 4,2);
    push_texture();
    hud_def(3,3, t3,4,2);

    cube_def(ERROR_CUBE-13, SolidBlock, "cell13", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 5,2);
    push_texture();
    hud_def(3,4, t3,5,2);
    
    cube_def(ERROR_CUBE-14, SolidBlock, "cell14", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 6,2);
    push_texture();
    hud_def(3,5, t3,6,2);
    
    cube_def(ERROR_CUBE-15, SolidBlock, "cell15", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 7,2);
    push_texture();
    hud_def(3,7, t3,7,2);

    cube_def(ERROR_CUBE-16, SolidBlock, "cell16", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 8,2);
    push_texture();
    hud_def(3,8, t3,8,2);
    
    cube_def(ERROR_CUBE-17, SolidBlock, "cell17", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 1,3);
    push_texture();
    hud_def(4,1, t3,1,3);
    
    cube_def(ERROR_CUBE-18, SolidBlock, "cell18", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 2,3);
    push_texture();
    hud_def(4,2, t3,2,3);
    
    cube_def(ERROR_CUBE-19, SolidBlock, "cell19", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 3,3);
    push_texture();
    hud_def(4,3, t3,3,3);
    
    cube_def(ERROR_CUBE-20, SolidBlock, "cell20", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 4,3);
    push_texture();
    hud_def(4,4, t3,4,3);
    
    cube_def(ERROR_CUBE-21, SolidBlock, "cell21", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 5,3);
    ...
    cube_def(ERROR_CUBE-22, SolidBlock, "cell22", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 6,3);
    push_texture();
    hud_def(4,6, t3,6,3);

    cube_def(ERROR_CUBE-23, SolidBlock, "cell23", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 7,3);
    ...
    cube_def(ERROR_CUBE-24, SolidBlock, "cell24", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 8,3);
    push_texture();
    hud_def(4,8, t3,8,3);
    
    cube_def(ERROR_CUBE-25, SolidBlock, "cell25", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 1,4);
    push_texture();
    hud_def(5,4, t3,1,4);
    
    cube_def(ERROR_CUBE-26, SolidBlock, "cell26", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 2,4);
    push_texture();
    hud_def(5,5, t3,2,4);
    
    cube_def(ERROR_CUBE-27, SolidBlock, "cell27", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 3,4);
    push_texture();
    hud_def(5,6, t3,3,4);

    cube_def(ERROR_CUBE-28, SolidBlock, "cell28", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 4,4);
    push_texture();
    hud_def(5,7, t3,4,4);

    cube_def(ERROR_CUBE-29, SolidBlock, "cell29", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 5,4);
    push_texture();
    hud_def(5,8, t3,5,4);

    cube_def(ERROR_CUBE-30, SolidBlock, "cell30", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 6,4);
    push_texture();
    hud_def(6,3, t3,6,4);

    cube_def(ERROR_CUBE-31, SolidBlock, "cell31", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 7,4);
    push_texture();
    hud_def(1,1, t3,7,4);

    cube_def(ERROR_CUBE-32, SolidBlock, "cell32", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 8,4);
    push_texture();
    hud_def(6,2, t3,8,4);

    cube_def(ERROR_CUBE-33, SolidBlock, "cell33", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 1,8);
    push_texture();
    hud_def(2,2, t3,1,8);
    
    cube_def(ERROR_CUBE-34, SolidBlock, "cell34", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 4,7);
    push_texture();
    hud_def(2,3, t3,4,7);
    
    cube_def(ERROR_CUBE-35, SolidBlock, "cell35", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 5,8);
    push_texture();
    hud_def(3,6, t3,5,8);
    
    cube_def(ERROR_CUBE-36, SolidBlock, "cell36", CUBE_MATERIAL_DECORATION);
    iso_texture(t3, 8,7);
    push_texture();
    hud_def(2,6, t3,8,7);
    ...
    cube_def(ERROR_CUBE-37, SolidBlock, "iceflame01", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,1);
    push_texture();
    hud_def(6,6, t6,1,1);
    
    cube_def(ERROR_CUBE-38, SolidBlock, "iceflame02", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,2);
    push_texture();
    hud_def(6,7, t6,1,2);
    
    cube_def(ERROR_CUBE-39, SolidBlock, "iceflame03", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,3);
    push_texture();
    hud_def(6,8, t6,1,3);
    
    cube_def(ERROR_CUBE-40, SolidBlock, "iceflame04", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,4);
    push_texture();
    hud_def(7,1, t6,1,4);
    
    cube_def(ERROR_CUBE-41, SolidBlock, "iceflame05", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,5);
    push_texture();
    hud_def(7,2, t6,1,5);
    
    cube_def(ERROR_CUBE-42, SolidBlock, "iceflame06", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,6);
    push_texture();
    hud_def(7,3, t6,1,6);
    
    cube_def(ERROR_CUBE-43, SolidBlock, "iceflame07", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,7);
    push_texture();
    hud_def(7,4, t6,1,7);
    
    cube_def(ERROR_CUBE-44, SolidBlock, "iceflame08", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 1,8);
    push_texture();
    hud_def(7,5, t6,1,8);
    ...
    cube_def(ERROR_CUBE-45, SolidBlock, "iceflame09", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 2,6);
    push_texture();
    hud_def(7,6, t6,2,6);
    
    cube_def(ERROR_CUBE-46, SolidBlock, "iceflame10", CUBE_MATERIAL_DECORATION);
    iso_texture(t6, 2,7);
    push_texture();
    hud_def(7,7, t6,2,7);
