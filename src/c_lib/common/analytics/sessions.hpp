...
class Session
{
    ...
    void print(FILE* f)
    {
        ...
        fprintf(f, "Session %4d; ", this->id);

        // version
        fprintf(f, "Version %d; ", this->version);
        
        // time
        fprintf(f, "%4ld seconds; ", this->logout_time - this->login_time);
        ...
        // count
        fprintf(f, "Login %2d; ", this->number+1);

        //client id
        fprintf(f, "Client id %2d; ", this->client_id);
