...
void send_container_insert(ClientID client_id, ItemID item_id, int container_id, int slot)
{
...
void agent_close_container_silent(AgentID agent_id, int container_id);  // doesnt send_container_close
