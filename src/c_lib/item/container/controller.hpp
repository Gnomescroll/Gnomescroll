...
ContainerActionType crusher_crush_alpha_action_decision_tree(int id, int slot);
#endif

#if DC_SERVER
// transactions
ContainerActionType alpha_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
...
ContainerActionType synthesizer_shopping_alpha_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
ContainerActionType synthesizer_shopping_beta_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);

ContainerActionType craft_input_alpha_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
ContainerActionType craft_input_beta_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
ContainerActionType craft_output_alpha_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
ContainerActionType craft_output_beta_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
...
ContainerActionType crusher_crush_alpha_action_decision_tree(AgentID agent_id, ClientID client_id, int id, int slot);
#endif
