...
(function($){
    $.fn.tipTip = function(options) {
        ...
        if (options === 'unbind') {
            return unbind_tiptip.call(this);
        }

        function unbind_tiptip() {
        ...
        return this.each(function(){
            ...
            if(org_title != ""){
                ...
                if(opts.activation == "hover"){
                    org_elem.bind('hover.tiptip', function(event){
                    ...
                    org_elem.bind('focus.tiptip', function(event){
                        if ($.isFunction(opts.activeMethod)) org_title = opts.activeMethod(event);
                        active_tiptip();
                    ...
                    org_elem.bind('click.tiptip', function(event){
