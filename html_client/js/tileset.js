...
var drawingCache = {
    ...
    resize : function resize() {
        ...
        // WTF
        // this does nothing but nonsense
        for(index in this.slookup) {
            if (this.slookup.hasOwnProperty(index)) {
                this.slookup = {};
            }
        }
    },
...
*/
        ...
        imgd = this.ctx.getImageData(0, 0, this.board.tile_pixel_width, this.board.tile_pixel_height);
        pix  = imgd.data;
    ...
    drawTile : function drawTile(x, y, tile_id) {
        ...
        if(!this.tlookup.hasOwnProperty(tile_id)) {
            ...
            rvalue = this.insertTile(tile_id);
...
*/
    ...
    drawSprite : function drawSprite(x, y, sprite_num, spriteMap_id) {
        ...
        if (!this.slookup[spriteMap_id].hasOwnProperty(sprite_num)) {
            this.insertSprite(sprite_num, spriteMap_id);
        }
