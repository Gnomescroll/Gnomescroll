...
class Perlin:
    ...
    def noise1(self, x):
        if self.filled:
            self.filled = False
            perlin1_fill(x, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeat, self.base)
        else:
            return perlin1(x, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeat, self.base)

    def noise2(self, x,y):
        if self.filled:
            print 'noise 2 filled'
            self.filled = False
            perlin2_fill(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeatx, self.repeaty, self.base)
        else:
            return perlin2(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeatx, self.repeaty, self.base)

    def noise3(self, x,y,z):
        if self.filled:
            self.filled = False
            perlin3_fill(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeatx, self.repeaty, self.repeatz, self.base)
        else:
            return perlin3(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeatx, self.repeaty, self.repeatz, self.base)
...
class Simplex:
    ...
    def noise2(self, x,y):
        if self.filled:
            self.filled = False
            simplex2_fill(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
        else:
            return simplex2(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
        
    def noise3(self, x,y,z):
        if self.filled:
            self.filled = False
            simplex3_fill(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
        else:
            return simplex3(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
...
class RMF:
    ...
    def pnoise1(self, x):
        if self.filled:
            self.filled = False
            rmf_perlin1_fill(x, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeat, self.base)
        else:
            return rmf_perlin1(x, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeat, self.base)
    ...
    def pnoise2(self, x,y):
        ...
        if self.filled:
            ...
            rmf_perlin2_fill(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeatx, self.repeaty, self.base)
        else:
    ...
    def pnoise3(self, x,y,z):
        if self.filled:
            ...
            return rmf_perlin3(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency, self.repeatx, self.repeaty, self.repeatz, self.base)

    def snoise2(self, x,y):
        if self.filled:
            self.filled = False
            rmf_simplex2_fill(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
        else:
            return rmf_simplex2(x, y, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
        
    def snoise3(self, x,y,z):
        if self.filled:
            self.filled = False
            rmf_simplex3_fill(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
        else:
            return rmf_simplex3(x, y, z, self.octaves, self.persistence, self.amplitude, self.lacunarity, self.frequency)
